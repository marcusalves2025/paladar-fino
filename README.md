...
<head>
    ...
    <title>Paladar Fino - Gastronomia Sofisticada</title>
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Montserrat:wght@300;400;500;600&family=Cormorant+Garamond:wght@300;400;500&display=swap" rel="stylesheet">
    ...
    <script>
        ...
        function openCourseModal(courseId) {
            ...
            content.innerHTML = `
                ...
                <button class="course-button" onclick="enrollCourse(${course.id})" style="width: 100%; font-size: 1.1rem;">
